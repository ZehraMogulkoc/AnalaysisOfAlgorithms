...
public class matrix
{
	public static void main(String [] args)
	{
		...
		initialize_2d_array_random(A_2);
        		...
        		System.out.println("strassen_matrix_multiply elapsed time in part 1c: " + elapsed_time);
        		
        		 start_time = System.nanoTime();
        		 square_matrix_multiply(A_2,B_2,C_2);
                 end_time = System.nanoTime();
                 elapsed_time = end_time - start_time;
         		System.out.println("square_matrix_multiply elapsed time in part 1e: " + elapsed_time);
		...
		//part 1(d)
                ...
                end_time = System.nanoTime();
                elapsed_time = end_time - start_time;
        		System.out.println("strassen_matrix_multiply elapsed time in part 1d: " + elapsed_time);
                //compute the elapsed time
                 ...
                 end_time = System.nanoTime();
                 elapsed_time = end_time - start_time;
         		System.out.println("square_matrix_multiply elapsed time in part 1f: " + elapsed_time);
